...
public final class SampleData {
    ...
    // NOTE: Verify.verifyPassword allows only these specials: @ # $ % ~ & * _ +
    ...
    public static List<User> users() throws Exception {
        ...
        // customers
        // Customer constructor: firstName, lastName, email, phone, password, [balance]
        list.add(new Customer("Ali", "Rezaei", "ali@mail.com", "09120000001", P1, 1000000));
        list.add(new Customer("Sara", "Nasiri", "sara@mail.com", "09120000002", P2));
        list.add(new Customer("Mina", "Taheri", "mina@mail.com", "09120000003", P3, 600000));
        list.add(new Customer("Hamed", "Ghasemi", "hamed@mail.com", "09120000004", P5));
        list.add(new Customer("Nima", "Karimi", "nima@mail.com", "09120000005", P6, 96243763));
        list.add(new Customer("Parsa", "Zahedi", "parsa@mail.com", "09120000006", P7));
        list.add(new Customer("Elham", "Kiani", "elham@mail.com", "09120000007", P1, 4577));
        list.add(new Customer("Reyhane", "Akbari", "rey@mail.com", "09120000008", P2));

        // sellers
        // Seller constructor: firstName, lastName, phone, password, storeCode, storeName, storeState, nationalId
        list.add(new Seller("Sara", "Mohammadi", "09123450001", P3, "ST1001", "Sara Store", "Tehran", "1122334455"));
        list.add(new Seller("Navid", "Ebrahimi", "09123450002", P4, "ST1002", "Navid Shop", "Shiraz", "2233445566"));
        list.add(new Seller("Leila", "Farahani", "09123450003", P5, "ST1003", "Leila Books", "Tabriz", "3344556677"));
        list.add(new Seller("Armin", "Soltani", "09123450004", P6, "ST1004", "Armin Digital", "Isfahan", "4455667788"));
        list.add(new Seller("Sahar", "Yazdani", "09123450005", P7, "ST1005", "Sahar Mobile", "Mashhad", "5566778899"));
