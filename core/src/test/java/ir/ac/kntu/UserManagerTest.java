...
public class UserManagerTest {
    ...
    void customerRegisterAndLoginByEmail() throws Exception {
        ...
        Customer c = new Customer("Ali", "Testi", "ali@test.com", "09120009999", "Abcd@1234");
    ...
    void uniquenessPhoneAndEmail() throws Exception {
        UserManager um = new UserManager();
        um.registerCustomer(new Customer("A", "B", "a@b.com", "09120000011", "Abcd@1234"));
        assertThrows(Exception.class, () -> um.registerCustomer(new Customer("C", "D", "a@b.com", "09120000012", "Abcd@1234")));
        assertThrows(Exception.class, () -> um.registerCustomer(new Customer("C", "D", "c@d.com", "09120000011", "Abcd@1234")));
    }
